...
export default function SEOLandingPage() {
  ...
  const blogPosts = [
    {
      ...
      image: '/img/modern.webp?height=200&width=400',
      date: 'May 15, 2024',
    },
    {
      ...
      image: '/img/marketing.webp?height=200&width=400',
      date: 'April 28, 2024',
    },
    {
      ...
      image: '/img/starting.webp?height=200&width=400',
      date: 'April 10, 2024',
    },
  ]
  ...
  return (
    <main className="w-full">
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-r from-primary to-primary-foreground py-20">
