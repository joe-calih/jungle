...
export default function Footer() {
  return (
    <footer className="w-full bg-white font-normal text-xs -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
      <div className="container mx-auto max-w-[1300px] px-4 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3	font-normal text-xs -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
