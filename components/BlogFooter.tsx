...
export default function Footer() {
  return (
    <footer className="w-full bg-white font-normal text-sm -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
      <div className="container mx-auto max-w-[1300px] px-4 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4	font-normal text-sm -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-center text-sm">© {new Date().getFullYear()} Semdeals. Powered by Semdeals Inc.</p>
